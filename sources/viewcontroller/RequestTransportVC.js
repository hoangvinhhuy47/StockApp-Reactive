...
export default class RequestTransportVC extends Component {
  constructor(props) {
    super(props);
  ...
  _WHousetransfer_click = async () => {
    this.props.navigation.push('WHousetransferVC', {
      checkForm: null,
    });
    return;
  };
  _WHouseImportTransfer_click = async () => {
    this.props.navigation.push('WHouseImportTransferVC', {
      checkForm: null,
    });
    return;
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.containerButon}>
          <TouchableOpacity onPress={this._WHousetransfer_click}>
            <View style={styles.backgroudButton}>
              <Image
                style={styles.ImageBT}
                source={require('../resources/Capture.png')}
              />
              <Text style={styles.textButton}>Xuất chuyển kho</Text>
              <Image
          ...
          <TouchableOpacity onPress={this._WHouseImportTransfer_click}>
            <View style={styles.backgroudButton}>
              <Image
                style={styles.ImageBT3}
                source={require('../resources/Capture2.png')}
              />
              <Text style={styles.textButton}>Nhập chuyển kho</Text>
              <Image
                style={styles.ImageBT2}
                source={require('../resources/right.png')}
              />
