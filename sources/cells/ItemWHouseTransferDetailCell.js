...
export default class ItemWHouseTransferDetailCell extends Component {
  constructor(props) {
    super(props);
    let canDelete = false;
        ...
        <View style={{flexDirection: 'row', justifyContent:'space-between', marginBottom:10}}>
          ...
          <View>
            <View style={{flexDirection: 'row'}}>
              <Text style={styles.Txt2}>ĐVT: </Text>
              <Text style={styles.Txt3}>{this.props.data.UnitName}</Text>
            </View>
          </View>
        </View>
        <View style={styles.groupBottom}>
          <View style={styles.groupsld}>
            <Text style={styles.Txt2}>SL: </Text>
            <TextInput
